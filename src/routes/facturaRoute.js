...
const { CAMPOS_FACTURA, CAMPOS_CONSULTA_LOTE_FACTURA } = require('../services/facturaService');
...
routes.post(
    ...
    query('fields').optional().isString().bail().custom(validarFields(CAMPOS_CONSULTA_LOTE_FACTURA)),
    ...
    facturaController.consultarFacturasPorIdExternoLote
);
